...
export const Hero = () => {
    ...
    const onSearch = async (e)=>{
        ...
        await axios.post('/api/user/store-recent-search', {recentSearchedCity:destination}, {headers: { Authorization:
  ...
  return (
    // BACKGROUND IMAGE URL (CHANGE IF YOU WANT ANY OTHER IMAGE IN BACKGROUND)
    /* P, H1, PFONT STYLING */
    ...
    bg-no-repeat bg-cover bg-center h-screen'>
        ...
        <h1 className='font-playfair text-2xl md:text-2xl md:text-5xl md:text-[56px] md:leading-[56px] font-bold md:font-extrabold max-w-xl mt-4'> Discover Your Perfect Gateway Destination</h1>
